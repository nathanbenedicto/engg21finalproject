...
Hypotheses: In order to test for the variabe's correlation, we test the following hypotheses with a confidence interval of 95% (𝜶 = 0.05) and let β1 be the regression coefficient:
...
Residual standard error: 15.4 on 671 degrees of freedom Multiple R-squared: 0.2135 Adjusted R-squared: 0.2123 F-statistic: 182.1 on 1 and 671 DF p-value: \< 2.2e-16

Residual standard error: 15.4 on 671 degrees of freedom Multiple R-squared: 0.2135, Adjusted R-squared: 0.2123 F-statistic: 182.1 on 1 and 671 DF, p-value: \< 2.2e-16 F = MStreatment / MSerror = 43205.8071123757/237.229901876195 = 182.126311947 F-crit = 182.1 on 1 and 671 DF

Regression equation: Attachment Anxiety = 98.47 - 1.994 Emotional Adaptability $\hat{y}$ = 98.47 --- 1.994x F = 182.1 F0.05, 1, 671 = 3.85 \< Fcrit \< 3.89 F \> $F_{crit}$ $p_{(f)}$ = 6.78926092488422E-37 P \< 0.05 Reject H0, regression is significant

[![image test](https://i.postimg.cc/Bn0Xr9bQ/regressionline.png)]
