...
>In order to test for the relationship of the two variables, we test the following hypotheses with a confidence interval of 95% (𝜶 = 0.05) and let β1 be the regression coefficient: 
...
| $F = MS_{Treatment} / MS_{Error}$ 
= 43205.8071123757 / 237.2299 = **182.126311947** |                            |                      |
